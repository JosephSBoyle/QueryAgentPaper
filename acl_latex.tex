...
Healthcare organisations collect vast quantities of healthcare data, however at present it would be difficult to argue that this data is used to it's \textit{full potential}. Whilst there has been a concerted effort from the machine learning researchers to automate various \textit{extractive} medical tasks such as clinical coding and radiology report generation, relatively few studies have investigated how to maximise the use of existing clinical data sources through generating automating the data analytics process.
