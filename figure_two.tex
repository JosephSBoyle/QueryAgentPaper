...
\begin{tikzpicture}[
    ...
    % outerbox/.style={rectangle, draw, thick, rounded corners, minimum width=3.5cm, minimum height=2cm, inner sep=6pt},
...
\node[database, below left=of ehealth, xshift=-3cm, yshift=-2.7cm] (patient_data)   {Patients};
...
\node[nhs-intranet, fit=(shc_icon) (ssc_icon) (phc_icon) (ehealth) (patient_data) (concept_db) (ehealth),
        label={[orange, font=\bfseries]above:NHS Intranet}] (nhs_fit) {};

% World Wide Web cloud
\node[www-cloud, fit=(llm) (umls), label={[red, font=\bfseries]:Internet}] (www_fit) {};
