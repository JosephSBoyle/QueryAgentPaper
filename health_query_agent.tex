...
\textsc{QA} & \Accuracy{} (\Passed{} / \Total{}) & \textbf{\Semanticparsingjaccardscore} & \textbf{\Recall} & \Precision & \Fscore & \Jaccardscore & \Tokensmean \\
...
\hline
\textsc{QA} & \sAccuracy{} (\sPassed{} / \sTotal{}) & \sSemanticparsingjaccardscore & \sRecall & \sPrecision & \sFscore & \sJaccardscore & \sTokensmean \\
...
\hline
% \textsc{QA+IR Agent} & 41.67 & 0.88 & 0.88  &  0.69 & 0.74 & 0.68 & 37,075 \\
% \textsc{QA+IR Agent + UMLS} & & tbc. -> & 0.88  &  0.69 & 0.74 & 0.68 & 37,075 \\

\end{tabular}}
\caption{
    QueryAgent's (QA) performance on epidemiological cohort questions, with and without the Information Retrieval (IR) sub-agent, and with/without access to UMLS. Performance is measured relative to a reference answer created by a professional analyst. EX. = Execution accuracy (exact match).
}
