...
% \hline
    ...
    &  (\%) & (\%) & rec. & prec. & F1-score & \\ 
\hline
\textsc{QA} & \Accuracy{} (\Passed{} / \Total{}) & \textbf{\Semanticparsingjaccardscore} & \textbf{\Recall} & \Precision & \Fscore & \Tokensmean \\

\textsc{+ IR Agent} & \irAccuracy{} (\irPassed{} / \irTotal{}) & \textbf{\irSemanticparsingjaccardscore} & \irRecall & \textbf{\irPrecision} & \irFscore & \irTokensmean \\

\textsc{+ IR Agent w/ UMLS} & \textbf{\IRumlsAccuracy{} (\IRumlsPassed{} / \IRumlsTotal{})} &  \IRumlsSemanticparsingjaccardscore & \IRumlsRecall & \IRumlsPrecision & \IRumlsFscore & \textbf{\IRumlsTokensmean} \\
\hline

\multicolumn{7}{l}{Sequential} \\
\hline
\textsc{QA} & \sAccuracy{} (\sPassed{} / \sTotal{}) & \sSemanticparsingjaccardscore & \sRecall & \sPrecision & \sFscore & \sTokensmean \\
\textsc{+IR Agent} &  \sirAccuracy{} (\sirPassed{} / \sirTotal{}) & \sirSemanticparsingjaccardscore & \sirRecall & \sirPrecision & \sirFscore & \sirTokensmean \\
\hline
\end{tabular}
}
\caption{
